    ...
    public static class Cards
    {
        ...
        public static HeroCard GetHeroCard()
        {
            var heroCard = new HeroCard
            {
                ...
                Images = new List<CardImage> { new CardImage("https://raw.githubusercontent.com/amido/azure-vector-icons/master/renders/traffic-manager.png") },
        ...
        public static ReceiptCard GetReceiptCard()
        {
            var receiptCard = new ReceiptCard
            {
                ...
                {
                    new ReceiptItem("Data Transfer", price: "$ 38.45", quantity: "368", image: new CardImage(url: "https://raw.githubusercontent.com/amido/azure-vector-icons/master/renders/traffic-manager.png")),
                    new ReceiptItem("App Service", price: "$ 45.00", quantity: "720", image: new CardImage(url: "https://raw.githubusercontent.com/amido/azure-vector-icons/master/renders/cloud-service.png"))
                },
                Tax = "$ 7.50",
                Total = "$ 90.95",
                Buttons = new List<CardAction>
                {
                    new CardAction(ActionTypes.OpenUrl,"More information","https://raw.githubusercontent.com/amido/azure-vector-icons/master/renders/traffic-manager.png",value:"https://azure.microsoft.com/en-us/pricing/")
                }
            };
        ...
        public static AnimationCard GetAnimationCard()
        {
            var animationCard = new AnimationCard
            {
                ...
                {
                    Url = "https://docs.microsoft.com/en-us/azure/bot-service/media/how-it-works/architecture-resize.png"
                },
